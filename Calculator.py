...
class Calculator:
    ...
    def __init__(self):
        ...
        Button(self.root,text="2",width=6,height=3,bg="pink",command=lambda: self.get_num("2")).grid(row=1,column=1)
        ...
        Button(self.root,text="5",width=6,height=3,bg="pink",command=lambda: self.get_num("5")).grid(row=2,column=1)
        ...
        Button(self.root,text="8",width=6,height=3,bg="pink",command=lambda: self.get_num("8")).grid(row=3,column=1)
        ...
        Button(self.root,text="C",width=6,height=3,bg="pink",command=lambda: self.get_clear()).grid(row=4,column=2)
        
        Button(self.root,text="=",width=6,height=3,bg="blue",command=lambda: self.get_result()).grid(row=4,column=3)
    ...
    def get_result(self):
        ...
        if self.operator=="+":
            ...
            if self.second_number==0:
                self.result.configure(text="Try Again!")
